...
class SubmissionForm extends Component {
  ...
  imageSelectHandler = e => {
    ...
    this.setState(
      ...
      () => {
        document.getElementById('your-image').src = window.URL.createObjectURL(
          this.state.image
        )
      }
    )
  ...
  render() {
    return (
      <>
        {this.state.isActive && (
          <div
            className="SubmissionForm__overlay"
              ...
              >
                ...
                {!this.state.image ? (
                    ...
                    <>
                      ...
                      {this.props.parent === 'Header' && (
                        <button
                          ...
                          onClick={() => this.imageInput.click()}
                        >
                          <AddToPhotos fontSize="default" />
                          <div className="button-text Aramanth">Add Post</div>
                        </button>
                      )}
                    </>
                  )
                  ...
                  <>
                    <button
                      onClick={() => this.resetState()}
                      className="SubmissionForm__button close"
                    >
                      <Close />
                    </button>
                    <img
                      className="SubmissionForm__img"
                      id="your-image"
                      alt="uploaded content"
                    />
                    <label className="SubmissionForm__label" htmlFor="text">
                      Caption Image
                    </label>
                    <input
                      className="SubmissionForm__input"
                      id="text"
                      type="text"
