...
export default class CommentFeed extends Component {
  ...
  handleSubmit = e => {
    ...
    CommentApi.postComment(this.props.id, commentText, id).then(res => {
          ...
          : comments.map(commentObj => {
              ...
              return (
                <Comment
                  key={comment_id}
                  text={comment_text}
                  username={this.state.usernames[user_id]}
                  timestamp={this.processTimestamp(comment_timestamp)}
                />
              )
            })}
        <form
          onSubmit={e => this.handleSubmit(e)}
          className="CommentFeed__form"
        >
          ...
          userLoggedIn ? (
            ...
            <>
              ...
              <input
                ...
                disabled
              />
              <button type="submit" className="CommentFeed__button" disabled>
                Post
              </button>
            </>
          )}
